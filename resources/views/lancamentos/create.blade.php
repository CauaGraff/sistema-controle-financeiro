...
<div class="container mt-5">
    ...
    <form action="{{ route('lancamentos.pagamentos.store') }}" method="POST">
        ...
        <div id="parcelasFields" style="display: none;">
            ...
            <!-- Campo de Data de Vencimento -->
            <div class="row mb-3">
                <label for="data_vencimento" class="col-sm-2 col-form-label" id="labelDataVenc">1º Data de
                    Vencimento</label>
                <div class="col-sm-10">
                    <input type="date" class="form-control" id="data_vencimento" name="data_vencimento">
                </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="date" class="form-control" id="valorEntrada" name="valorEntrada">
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="date" class="form-control" id="qtdParcelas" name="qtdParcelas">
                </div>
            </div>
        </div>
        ...
        <!-- Campo de Favorecido -->
        <div class="row mb-3">
            <label for="favorecido" class="col-sm-2 col-form-label">Fornecedor/Cleinte</label>
            <div class="col-sm-10">
                <select class="form-select" id="favorecido" name="favorecido_id">
