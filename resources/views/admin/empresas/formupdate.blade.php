        ...
        <div class="card shadow">
            <div class="card-body p-4">
                <form method="POST" action="{{ route('adm.empresas.update', $empresa->id) }}">
                    @csrf
                    @method('PUT') <!-- Indica que a requisição é uma atualização (PUT) -->
                    <div class="row mb-3">
                        <!-- Nome -->
                        <div class="col">
                        ...
                        <div class="col">
                            ...
                            <input type="text" class="form-control @error('cnpj_cpf') is-invalid @enderror"
                                id="cnpj_cpf" name="cnpj_cpf" value="{{ old('cnpj_cpf', $empresa->cnpj_cpf) }}" required>
                            @error('cnpj_cpf')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col">
                            ...
                            <input type="text" class="form-control @error('cidade') is-invalid @enderror" id="cidade"
                                name="cidade" value="{{ old('cidade', $empresa->cidade) }}" required>
                            @error('cidade')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="col">
                            ...
                            <input type="text" class="form-control @error('bairro') is-invalid @enderror" id="bairro"
                                name="bairro" value="{{ old('bairro', $empresa->bairro) }}" required>
                            @error('bairro')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
